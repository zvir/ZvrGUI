package zvr.zvrND2D 
{
	 ...
	 * @author Zvir
	 */
	public class AdvandedFontTextureGenerator 
	{
		...
		public function AdvandedFontTextureGenerator() 
		{
		...
		public static function texture(chars:String, font:String, fontSize:Number, fontColor:uint):BitmapData
		{
			...
			for (var i:int = 0; i < chars.length; i++) 
			{
				...
				/*rf.width = Math.ceil(rf.width);
				rf.height = Math.ceil(rf.height);*/
				
				trace(rf, "'" + textField.text + "'");
				
				m.identity();
				
				rf && m.translate( -rf.x+x, -rf.y);
