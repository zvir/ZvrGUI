package zvr.zvrG2D 
{
	...
	public class ZvrGTransform extends GTransform
	{
		...
		override public function get worldTransformMatrix():Matrix3D {
		...
		override public function get localTransformMatrix():Matrix3D {
		...
		override public function getTransformedWorldTransformMatrix(p_scaleX:Number, p_scaleY:Number, p_rotation:Number, p_invert:Boolean):Matrix3D {
		...
		*/
		public function ZvrGTransform(p_node:GNode) {
			super(p_node);
		}
		
		
		override g2d function invalidate(p_invalidateTransform:Boolean, p_invalidateColor:Boolean) : void {
...
*/
        private function recursiveInvalidate(p_transform:GTransform):Boolean {
            ...
            if (parentTransformUpdate) invalidate(true, false);
